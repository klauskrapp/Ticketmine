...
@section('content')
    ...
    <div class="body flex-grow-1">
        @include('components.headline', array('headline' => $entity->id == '' ? __('state.create_state') : __('global.edit') . ' "' . $entity->name . '"'  ) )
        <div class="card p-3">
            <form action="{{url('state/save')}}" method="POST" id="state-form">
                @csrf
                <div class="card-body">
                ...
                <div class="card-footer">
                    <div class="row">
                        ...
                        <div class="col-6 text-end">
                            <button type="submit" class="btn btn-success btn-lg" onclick="return State.save();">{{__('global.save')}}</button>
                        </div>
                    </div>
                </div>
